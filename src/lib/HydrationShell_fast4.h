...
/*
   inline bool GetDensity(Real &density, CubeStruct &Cube, Matrix &AtomTypesDensityMatrix, Matrix &ElementsDensityMatrix, Matrix &NormalDensityMatrix, Matrix &NormalElementsDensityMatrix, Real BulkDensity, ParamStruct &params, Real RecBin, vector<AtomStruct> &Atoms, bool BoolPrint)
   {
   int SolventType, MaxIntDist, Size, NumSolventTypes;
   SolventType=Cube.AtomType;
   MaxIntDist=AtomTypesDensityMatrix[SolventType].size();
   NumSolventTypes=AtomTypesDensityMatrix.size();
   density=UNK_DENSITY;
   BoolPrint=false;
...
{
SolventType=Cube.ElementType;
MaxIntDist=ElementsDensityMatrix[SolventType].size();
if (Cube.IntDist<MaxIntDist)
{
if (BoolPrint) cout <<"ElementsDensityMatrix= "<<ElementsDensityMatrix[SolventType][Cube.IntDist]<<endl;
density=ElementsDensityMatrix[SolventType][Cube.IntDist];
...
MaxIntDist=NormalDensityMatrix[SolventType].size();
if (Cube.IntDist<MaxIntDist)
{
...
if (density==UNK_DENSITY)
{
        ...
        MaxIntDist=NormalElementsDensityMatrix[SolventType].size();
        if (Cube.IntDist<MaxIntDist)
        {
                density=NormalElementsDensityMatrix[SolventType][Cube.IntDist];
                if (BoolPrint) cout <<"NormalDensityMatrix= "<<NormalDensityMatrix[SolventType][Cube.IntDist]<<endl;
                if (Cube.MinDist>params.MaxDistForZeroDensity && density==0) density=UNK_DENSITY;
        }
}
...
void VerySafeMakeGrid(Real xmin, Real ymin, Real zmin, Real xmax, Real ymax, Real zmax, vector<AtomStruct> &Atoms, Real maxhs, Real CubeSize, vector<CubeStruct> &Cubes, string PdbFile, Matrix &AtomTypesDensityMatrix, Matrix &ElementsDensityMatrix, Matrix &NormalDensityMatrix, Matrix &NormalElementsDensityMatrix, bool PhobicPhilic, Real BulkDensity, ParamStruct &params)
{
                                ...
                                if (true)
                                {
                                        ...
                                        if (LocatedIn==InHydrationShell) 
                                        {
                                                ...
                                                if (Cube.MinDist<maxhs)
                                                {
                                                        ...
                                                        GetDensity(Cube.density, Cube, AtomTypesDensityMatrix, ElementsDensityMatrix, NormalDensityMatrix, NormalElementsDensityMatrix, BulkDensity, params, params.RecBin, Atoms, false);
...
void AssignCubeDensities(vector<CubeStruct> &Cubes, vector<AtomStruct> &Atoms, Matrix &AtomTypesDensityMatrix, Matrix &ElementsDensityMatrix, Matrix &NormalDensityMatrix, Matrix &NormalElementsDensityMatrix, Real BulkDensity, bool UniformHydrationShellDensity, Real HydrationShellDensity, ParamStruct &params, Real RecBin)
{
        ...
        for (n=0;n<GridPoints;n++)
        {
                ...
                if (Cubes[n].LocatedIn==InHydrationShell)
                {
                        ...
                        SetDensity=GetDensity(density, Cubes[n], AtomTypesDensityMatrix, ElementsDensityMatrix, NormalDensityMatrix, NormalElementsDensityMatrix, BulkDensity, params, RecBin, Atoms, BoolPrint);
...
void BuildHydrationShell(vector<CubeStruct> &Cubes, vector<AtomStruct> &Atoms, Matrix &AtomTypesDensityMatrix, Matrix &ElementsDensityMatrix, Matrix &NormalDensityMatrix, Matrix &NormalElementsDensityMatrix, Real BulkDensity, bool UniformHydrationShell, Real hsdensity, ParamStruct &params)
{
        SetUpGrid(Cubes, Atoms, params);
        AssignCubeDensities(Cubes, Atoms, AtomTypesDensityMatrix, ElementsDensityMatrix, NormalDensityMatrix, NormalElementsDensityMatrix, BulkDensity, UniformHydrationShell, hsdensity, params, params.RecBin);
