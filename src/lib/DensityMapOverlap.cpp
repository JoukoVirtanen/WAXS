...
Real ComparePDBs(Real contrast, vector<CubeStruct> &Cubes1, vector<CubeStruct> &Cubes2, vector<AtomStruct> &Atoms, bool PrintDifferencePdb)
{
        bool verbose=false;
...
Real ComparePDBs(Real contrast, vector<AtomStruct> &Atoms1, vector<AtomStruct> &Atoms2, vector<AtomStruct> &DiffAtoms, bool PrintDifferencePdb)
{
        ...
        ComparePDBs(contrast, Cubes1, Cubes2, DiffAtoms, PrintDifferencePdb);
